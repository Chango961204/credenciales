...
const CredencialPage = () => {
  ...
  if (loading)
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        <p className="text-lg text-gray-600 font-semibold">Cargando credencial...</p>
      </div>
    );
  ...
  if (!empleado)
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        <p className="text-lg text-red-600 font-semibold">Empleado no encontrado</p>
      </div>
    );
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white shadow-2xl rounded-2xl w-96 p-4 text-center border-t-4 border-green-600">
        ...
        <h2 className="text-xl font-bold text-gray-800 uppercase mb-2">{empleado.nom_trab}</h2>
        <p className="text-sm text-gray-700 mb-1 font-semibold uppercase">
          {empleado.nom_depto || "Sin departamento"}
        </p>
        <p className="text-sm text-gray-700 mb-1 uppercase">{empleado.puesto || "Sin puesto"}</p>
        <p className="text-sm text-gray-500 font-mono mb-3">{empleado.num_trab}</p>
